    ...
    data() {
        return {
            ...
            options: [
                ...
                { id: 3, name: 'Tarif pour 4 personnes', price: '70 €', unit: 'pour tout le groupe', note: '4 personnes minimum' },
                { id: 4, name: 'Tarif pour 6 personnes', price: '100 €', unit: 'pour tout le groupe', note: '6 personnes minimum'  },
            ],
        };
    },
    methods: {
